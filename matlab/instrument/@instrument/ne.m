...
%NE Overload of ~= for instrument objects.
%

%   MP 7-13-99
%   Copyright 1999-2009 The MathWorks, Inc. 
%   $Revision: 1.1.6.2 $  $Date: 2011/05/13 18:06:24 $
...
if isempty(arg1)
    if (length(arg2) == 1)
       ...
       error(message('instrument:ne:dimagree'));
   end
   return;
elseif isempty(arg2)
   if (length(arg1) == 1)
...
try   
   ...
   isneq = (jarg1 ~= jarg2);
    ...
    % Rethrow error from above.
     if strcmp(aException.identifier, 'instrument:ne:dimagree')
        rethrow(aException);
    end
