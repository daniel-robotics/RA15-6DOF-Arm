...
%   .m    file    open file in MATLAB Editor
%   .mdl  file    open model in SIMULINK
%   .p    file    open the matching file with a .m extension if there is one
...
%   $Revision: 1.1.6.3 $  $Date: 2011/05/13 18:06:27 $

error(message('instrument:open:unsupportedFcn'));
