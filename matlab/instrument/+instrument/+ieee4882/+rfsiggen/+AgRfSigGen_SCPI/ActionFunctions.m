classdef ActionFunctions < instrument.ieee4882.rfsiggen.ActionFunctions & instrument.ieee4882.rfsiggen.AgRfSigGen_SCPI.Agilentbase
    % ACTIONFUNCTIONS This class contains functions
    ...
    methods
        ...
        function DisableAllModulation(obj)
            ...
            narginchk(1,1)
            obj.sendCmdToInstrument('OUTPut:MODulation:STATe OFF');
        end
        
        function SendSoftwareTrigger(obj)
            % SENDSOFTWARETRIGGER This function triggers the device if BUS
