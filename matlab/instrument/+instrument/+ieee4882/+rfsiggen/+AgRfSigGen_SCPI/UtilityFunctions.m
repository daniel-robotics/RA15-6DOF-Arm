classdef UtilityFunctions < instrument.ieee4882.rfsiggen.UtilityFunctions & instrument.ieee4882.rfsiggen.AgRfSigGen_SCPI.Agilentbase
    % UTILITYFUNCTIONS This class contains functions
    % that control common instrument operations.
    ...
    % functions that access error information, lock the
    ...
    properties  (Constant)
        % REVISION Revision of the specific driver, which is the value
    ...
    methods
        ...
        function [manufacturer, model] = getInstrumentInfo(obj)
            % GETINSTRUMENTINFO Get information from connected instrument.
