classdef RF < instrument.ieee4882.rfsiggen.RF & instrument.ieee4882.rfsiggen.AgRfSigGen_SCPI.Agilentbase
    ...
    methods
        ...
        function value = get.Frequency(obj)
            % Get the Frequency
            value = str2double(obj.queryInstrument('FREQuency:CW?'));
        end
        function set.Frequency(obj,newValue)
            % Set the Frequency
            obj.sendCmdToInstrument(['FREQuency:CW ', num2str(newValue)]);
        end
        ...
        function set.PowerLevel(obj,newValue)
            % Set the Power Level
            obj.sendCmdToInstrument(['POWer:LEVel:IMMediate:AMPLitude ', num2str(newValue)]);
        end
    ...
    methods
        ...
        function ConfigureOutputEnabled(obj,OutputEnabled)
            ...
            narginchk(2,2)
            obj.OutputEnabled = obj.checkScalarBoolArg(OutputEnabled);
        end
    end
end
