    ...
    methods
        function CoercionRecord = GetNextCoercionRecord(obj,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviDmm_GetNextCoercionRecord', session, BufferSize, CoercionRecord);
