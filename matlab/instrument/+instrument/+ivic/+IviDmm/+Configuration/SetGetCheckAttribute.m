classdef SetGetCheckAttribute < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = SetGetCheckAttribute()
            ...
            obj.SetAttribute = instrument.ivic.IviDmm.Configuration.SetGetCheckAttribute.SetAttribute();
            obj.GetAttribute = instrument.ivic.IviDmm.Configuration.SetGetCheckAttribute.GetAttribute();
            obj.CheckAttribute = instrument.ivic.IviDmm.Configuration.SetGetCheckAttribute.CheckAttribute();
        end
