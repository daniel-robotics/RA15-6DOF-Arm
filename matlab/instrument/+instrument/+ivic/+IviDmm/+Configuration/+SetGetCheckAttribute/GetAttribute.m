    ...
    methods
        function AttributeValue = GetAttributeViInt32(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviDmm_GetAttributeViInt32', session, ChannelName, AttributeID, AttributeValue);
        ...
        function AttributeValue = GetAttributeViReal64(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviDmm_GetAttributeViReal64', session, ChannelName, AttributeID, AttributeValue);
        ...
        function AttributeValue = GetAttributeViString(obj,ChannelName,AttributeID,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviDmm_GetAttributeViString', session, ChannelName, AttributeID, BufferSize, AttributeValue);
        ...
        function AttributeValue = GetAttributeViBoolean(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviDmm_GetAttributeViBoolean', session, ChannelName, AttributeID, AttributeValue);
        ...
        function AttributeValue = GetAttributeViSession(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviDmm_GetAttributeViSession', session, ChannelName, AttributeID, session);
