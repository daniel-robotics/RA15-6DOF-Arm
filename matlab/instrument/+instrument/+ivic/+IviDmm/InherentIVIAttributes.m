classdef InherentIVIAttributes < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = InherentIVIAttributes()
            ...
            obj.UserOptions = instrument.ivic.IviDmm.InherentIVIAttributes.UserOptions();
            obj.ClassDriverIdentification = instrument.ivic.IviDmm.InherentIVIAttributes.ClassDriverIdentification();
            obj.SpecificDriverIdentification = instrument.ivic.IviDmm.InherentIVIAttributes.SpecificDriverIdentification();
            obj.SpecificDriverCapabilities = instrument.ivic.IviDmm.InherentIVIAttributes.SpecificDriverCapabilities();
            obj.InstrumentIdentification = instrument.ivic.IviDmm.InherentIVIAttributes.InstrumentIdentification();
            obj.AdvancedSessionInformation = instrument.ivic.IviDmm.InherentIVIAttributes.AdvancedSessionInformation();
        end
