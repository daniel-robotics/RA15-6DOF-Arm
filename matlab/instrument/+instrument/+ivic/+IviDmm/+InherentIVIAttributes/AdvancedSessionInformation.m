classdef AdvancedSessionInformation < instrument.ivic.IviGroupBase
    ...
    properties (SetAccess = private)
        ...
        %through the IVI Configuration Utility.     The default
        %value is an empty string. Read Only.
        Driver_Setup
        
        %LOGICAL_NAME A string containing the logical name you
        %specified when opening the current IVI session.      You
        %may pass a logical name to the IviDmm_init or
        %IviDmm_InitWithOptions functions.  The IVI Configuration
