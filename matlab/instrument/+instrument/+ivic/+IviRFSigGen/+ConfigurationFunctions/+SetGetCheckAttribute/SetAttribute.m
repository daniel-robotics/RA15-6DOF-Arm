    ...
    methods
        function SetAttributeViInt32(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviRFSigGen_SetAttributeViInt32', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function SetAttributeViReal64(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviRFSigGen_SetAttributeViReal64', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function SetAttributeViString(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviRFSigGen_SetAttributeViString', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function SetAttributeViBoolean(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviRFSigGen_SetAttributeViBoolean', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function SetAttributeViSession(obj,RepeatedCapabilityName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviRFSigGen_SetAttributeViSession', session, RepeatedCapabilityName, AttributeID, session);
