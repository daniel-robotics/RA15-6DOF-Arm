classdef SetGetCheckAttribute < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = SetGetCheckAttribute()
            ...
            obj.SetAttribute = instrument.ivic.IviRFSigGen.ConfigurationFunctions.SetGetCheckAttribute.SetAttribute();
            obj.GetAttribute = instrument.ivic.IviRFSigGen.ConfigurationFunctions.SetGetCheckAttribute.GetAttribute();
            obj.CheckAttribute = instrument.ivic.IviRFSigGen.ConfigurationFunctions.SetGetCheckAttribute.CheckAttribute();
        end
