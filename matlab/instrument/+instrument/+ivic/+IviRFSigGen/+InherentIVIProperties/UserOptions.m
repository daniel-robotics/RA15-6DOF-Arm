classdef UserOptions < instrument.ivic.IviGroupBase
    ...
    properties
        ...
        %Use the IviRFSigGen_InitWithOptions function to override
        %this value.
        Range_Check
        ...
        %IviRFSigGen_InitWithOptions function to override this value.
        ...
        %IviRFSigGen_InitializeWithOptions function to override this
        %value.
        Cache
        ...
        %return calculated values.     The default value is
        %VI_FALSE.   Use the IviRFSigGen_InitWithOptions function to
        %override this value.
        Simulate
        ...
        %IviRFSigGen_GetNextCoercionRecord function to extract and
        ...
        %warnings.  The default value is VI_FALSE.
        %Interchangeability warnings indicate that using your
        %application with a different instrument might cause
        %different behavior.  You call IviRFSigGen Get Next
        %Interchange Warning to extract interchange warnings.  Call
        %the IviRFSigGen_ClearInterchangeWarnings function to clear
        %the list of interchangeability warnings without reading
        %them. Interchangeability checking logs a warning for each
    ...
    methods
        ...
        function set.Range_Check(obj,newValue)
            ...
            [libName, session] = obj.getLibraryAndSession();
            attributAccessors.setLibraryAndSession(libName, session);
            import instrument.ivic.IviRFSigGen.InherentIVIProperties.UserOptions.*;
