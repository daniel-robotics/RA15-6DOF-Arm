classdef ErrorInfo < instrument.ivic.IviGroupBase
    ...
    methods
        function [Code,Description] = GetError(obj,BufferSize)
            ...
            %since the user last called IviRFSigGen_GetError or
            %IviRFSigGen_ClearError.
            ...
            try
                ...
                status = calllib( libname,'IviRFSigGen_GetError', session, Code, BufferSize, Description);
        ...
        function ClearError(obj)
            ...
            %have a session handle to pass to the IviRFSigGen_GetError
            %function, which occurs when a call to IviRFSigGen_init or
            %IviRFSigGen_InitWithOptions fails.
            
            narginchk(1,1)
            try
                [libname, session ] = obj.getLibraryAndSession();
                
                status = calllib( libname,'IviRFSigGen_ClearError', session);
