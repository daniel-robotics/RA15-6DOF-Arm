classdef ErrorInfo < instrument.ivic.IviGroupBase
    ...
    methods
        function [Code,Description] = GetError(obj,BufferSize)
            ...
            %since the user last called IviSwtch_GetError or
            %IviSwtch_ClearError.
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_GetError', session, Code, BufferSize, Description);
        ...
        function ClearError(obj)
            ...
            %have a session handle to pass to the IviSwtch_GetError
            %function, which occurs when a call to IviSwtch_init or
            %IviSwtch_InitWithOptions fails.
            
            narginchk(1,1)
            try
                [libname, session ] = obj.getLibraryAndSession();
                
                status = calllib( libname,'IviSwtch_ClearError', session);
