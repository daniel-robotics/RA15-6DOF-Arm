    ...
    methods
        function CoercionRecord = GetNextCoercionRecord(obj,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_GetNextCoercionRecord', session, BufferSize, CoercionRecord);
