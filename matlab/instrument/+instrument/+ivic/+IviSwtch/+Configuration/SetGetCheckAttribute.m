classdef SetGetCheckAttribute < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = SetGetCheckAttribute()
            ...
            obj.SetAttribute = instrument.ivic.IviSwtch.Configuration.SetGetCheckAttribute.SetAttribute();
            obj.GetAttribute = instrument.ivic.IviSwtch.Configuration.SetGetCheckAttribute.GetAttribute();
            obj.CheckAttribute = instrument.ivic.IviSwtch.Configuration.SetGetCheckAttribute.CheckAttribute();
        end
