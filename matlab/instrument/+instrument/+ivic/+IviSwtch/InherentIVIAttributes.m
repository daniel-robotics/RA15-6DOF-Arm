classdef InherentIVIAttributes < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = InherentIVIAttributes()
            ...
            obj.UserOptions = instrument.ivic.IviSwtch.InherentIVIAttributes.UserOptions();
            obj.ClassDriverIdentification = instrument.ivic.IviSwtch.InherentIVIAttributes.ClassDriverIdentification();
            obj.SpecificDriverIdentification = instrument.ivic.IviSwtch.InherentIVIAttributes.SpecificDriverIdentification();
            obj.SpecificDriverCapabilities = instrument.ivic.IviSwtch.InherentIVIAttributes.SpecificDriverCapabilities();
            obj.InstrumentIdentification = instrument.ivic.IviSwtch.InherentIVIAttributes.InstrumentIdentification();
            obj.AdvancedSessionInformation = instrument.ivic.IviSwtch.InherentIVIAttributes.AdvancedSessionInformation();
        end
