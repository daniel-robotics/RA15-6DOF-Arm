classdef AdvancedSessionInformation < instrument.ivic.IviGroupBase
    ...
    properties (SetAccess = private)
        ...
        %IviSwtch_InitWithOptions function.  If you open an
        ...
        %may pass a logical name to the IviSwtch_init or
        %IviSwtch_InitWithOptions functions.  The IVI Configuration
