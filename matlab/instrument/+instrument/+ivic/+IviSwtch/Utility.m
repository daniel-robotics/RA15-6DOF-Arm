classdef Utility < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = Utility()
            ...
            obj.ErrorInfo = instrument.ivic.IviSwtch.Utility.ErrorInfo();
            obj.InterchangeabilityInfo = instrument.ivic.IviSwtch.Utility.InterchangeabilityInfo();
            obj.CoercionInfo = instrument.ivic.IviSwtch.Utility.CoercionInfo();
            obj.Locking = instrument.ivic.IviSwtch.Utility.Locking();
        end
    ...
    methods
        function reset(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_reset', session);
        ...
        function ResetWithDefaults(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_ResetWithDefaults', session);
        ...
        function [SelfTestResult,SelfTestMessage] = self_test(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_self_test', session, SelfTestResult, SelfTestMessage);
        ...
        function Disable(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_Disable', session);
        ...
        function InvalidateAllAttributes(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_InvalidateAllAttributes', session);
        ...
        function [InstrumentDriverRevision,FirmwareRevision] = revision_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_revision_query', session, InstrumentDriverRevision, FirmwareRevision);
        ...
        function [ErrorCode,ErrorMessage] = error_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_error_query', session, ErrorCode, ErrorMessage);
        ...
        function ErrorMessage = error_message(obj,ErrorCode)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_error_message', session, ErrorCode, ErrorMessage);
        ...
        function ChannelString = GetChannelName(obj,Index,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_GetChannelName', session, Index, BufferSize, ChannelString);
        ...
        function SpecificDriverCHandle = GetSpecificDriverCHandle(obj)
            ...
            try
                ...
                status = calllib( libname,'IviSwtch_GetSpecificDriverCHandle', session, SpecificDriverCHandle);
