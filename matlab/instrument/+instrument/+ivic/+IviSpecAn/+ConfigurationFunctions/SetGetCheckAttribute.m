classdef SetGetCheckAttribute < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = SetGetCheckAttribute()
            ...
            obj.SetAttribute = instrument.ivic.IviSpecAn.ConfigurationFunctions.SetGetCheckAttribute.SetAttribute();
            obj.GetAttribute = instrument.ivic.IviSpecAn.ConfigurationFunctions.SetGetCheckAttribute.GetAttribute();
            obj.CheckAttribute = instrument.ivic.IviSpecAn.ConfigurationFunctions.SetGetCheckAttribute.CheckAttribute();
        end
