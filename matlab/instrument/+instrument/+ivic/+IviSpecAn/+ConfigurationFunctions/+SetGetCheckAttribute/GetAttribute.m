    ...
    methods
        function AttributeValue = GetAttributeViInt32(obj,RepeatedCapabilityName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_GetAttributeViInt32', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function AttributeValue = GetAttributeViReal64(obj,RepeatedCapabilityName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_GetAttributeViReal64', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function AttributeValue = GetAttributeViString(obj,RepeatedCapabilityName,AttributeID,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_GetAttributeViString', session, RepeatedCapabilityName, AttributeID, BufferSize, AttributeValue);
        ...
        function AttributeValue = GetAttributeViBoolean(obj,RepeatedCapabilityName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_GetAttributeViBoolean', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function AttributeValue = GetAttributeViSession(obj,RepeatedCapabilityName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_GetAttributeViSession', session, RepeatedCapabilityName, AttributeID, session);
