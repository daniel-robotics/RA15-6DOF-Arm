    ...
    methods
        function CheckAttributeViInt32(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_CheckAttributeViInt32', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViReal64(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_CheckAttributeViReal64', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViString(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_CheckAttributeViString', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViBoolean(obj,RepeatedCapabilityName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_CheckAttributeViBoolean', session, RepeatedCapabilityName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViSession(obj,RepeatedCapabilityName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_CheckAttributeViSession', session, RepeatedCapabilityName, AttributeID, session);
