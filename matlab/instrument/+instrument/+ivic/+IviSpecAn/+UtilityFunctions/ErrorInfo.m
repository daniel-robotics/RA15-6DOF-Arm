classdef ErrorInfo < instrument.ivic.IviGroupBase
    ...
    methods
        function [Code,Description] = GetError(obj,BufferSize)
            ...
            %since the user last called IviSpecAn_GetError or
            %IviSpecAn_ClearError.
            ...
            try
                ...
                status = calllib( libname,'IviSpecAn_GetError', session, Code, BufferSize, Description);
        ...
        function ClearError(obj)
            ...
            %have a session handle to pass to the IviSpecAn_GetError
            %function, which occurs when a call to IviSpecAn_init or
            %IviSpecAn_InitWithOptions fails.
            
            narginchk(1,1)
            try
                [libname, session ] = obj.getLibraryAndSession();
                
                status = calllib( libname,'IviSpecAn_ClearError', session);
