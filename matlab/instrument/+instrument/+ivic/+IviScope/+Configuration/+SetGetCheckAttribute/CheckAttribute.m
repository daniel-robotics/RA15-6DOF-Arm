    ...
    methods
        function CheckAttributeViInt32(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviScope_CheckAttributeViInt32', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViReal64(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviScope_CheckAttributeViReal64', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViString(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviScope_CheckAttributeViString', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViBoolean(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviScope_CheckAttributeViBoolean', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViSession(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviScope_CheckAttributeViSession', session, ChannelName, AttributeID, session);
