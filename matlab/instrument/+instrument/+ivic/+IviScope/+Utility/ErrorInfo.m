classdef ErrorInfo < instrument.ivic.IviGroupBase
    ...
    methods
        function [Code,Description] = GetError(obj,BufferSize)
            ...
            %since the user last called IviScope_GetError or
            %IviScope_ClearError.
            ...
            try
                ...
                status = calllib( libname,'IviScope_GetError', session, Code, BufferSize, Description);
        ...
        function ClearError(obj)
            ...
            %have a session handle to pass to the IviScope_GetError
            %function, which occurs when a call to IviScope_init or
            %IviScope_InitWithOptions fails.
            
            narginchk(1,1)
            try
                [libname, session ] = obj.getLibraryAndSession();
                
                status = calllib( libname,'IviScope_ClearError', session);
