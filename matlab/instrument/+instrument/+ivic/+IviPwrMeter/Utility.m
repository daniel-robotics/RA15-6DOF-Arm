classdef Utility < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = Utility()
            ...
            obj.Error = instrument.ivic.IviPwrMeter.Utility.Error();
            obj.InterchangeabilityInfo = instrument.ivic.IviPwrMeter.Utility.InterchangeabilityInfo();
            obj.Locking = instrument.ivic.IviPwrMeter.Utility.Locking();
        end
        ...
        function setLibraryAndSession(obj, libName, session)
            ...
            obj.Error.setLibraryAndSession(libName, session);
        end
    end
    
    %% Public Read Only Properties
    properties (SetAccess = private)
        %ERROR This class contains functions that retrieve and
    ...
    methods
        function reset(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_reset', session);
        ...
        function ResetWithDefaults(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_ResetWithDefaults', session);
        ...
        function Disable(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_Disable', session);
        ...
        function [SelfTestResult,SelfTestMessage] = self_test(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_self_test', session, SelfTestResult, SelfTestMessage);
        ...
        function [InstrumentDriverRevision,FirmwareRevision] = revision_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_revision_query', session, InstrumentDriverRevision, FirmwareRevision);
        ...
        function [ErrorCode,ErrorMessage] = error_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_error_query', session, ErrorCode, ErrorMessage);
        ...
        function ErrorMessage = error_message(obj,ErrorCode)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_error_message', session, ErrorCode, ErrorMessage);
        ...
        function InvalidateAllAttributes(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_InvalidateAllAttributes', session);
        ...
        function SpecificDriverCHandle = GetSpecificDriverCHandle(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_GetSpecificDriverCHandle', session, SpecificDriverCHandle);
        ...
        function CoercionRecord = GetNextCoercionRecord(obj,BufferSize)
            ...
            %value.  If you set the IVIPWRMETER_ATTR_RECORD_COERCIONS
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_GetNextCoercionRecord', session, BufferSize, CoercionRecord);
