classdef SetGetCheckAttribute < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = SetGetCheckAttribute()
            ...
            obj.SetAttribute = instrument.ivic.IviPwrMeter.Configuration.SetGetCheckAttribute.SetAttribute();
            obj.GetAttribute = instrument.ivic.IviPwrMeter.Configuration.SetGetCheckAttribute.GetAttribute();
            obj.CheckAttribute = instrument.ivic.IviPwrMeter.Configuration.SetGetCheckAttribute.CheckAttribute();
        end
