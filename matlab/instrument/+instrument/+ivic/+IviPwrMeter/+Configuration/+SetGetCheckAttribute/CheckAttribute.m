classdef CheckAttribute < instrument.ivic.IviGroupBase
    %CHECKATTRIBUTE This class contains functions that
    %determine if you can set an attribute to a particular
    %value.  There are typesafe functions for each attribute
    %data type.
    ...
    methods
        function CheckAttributeViInt32(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_CheckAttributeViInt32', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViReal64(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_CheckAttributeViReal64', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViString(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_CheckAttributeViString', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViBoolean(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_CheckAttributeViBoolean', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViSession(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_CheckAttributeViSession', session, ChannelName, AttributeID, session);
