    ...
    methods
        function SetAttributeViInt32(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_SetAttributeViInt32', session, ChannelName, AttributeID, AttributeValue);
        ...
        function SetAttributeViReal64(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_SetAttributeViReal64', session, ChannelName, AttributeID, AttributeValue);
        ...
        function SetAttributeViString(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_SetAttributeViString', session, ChannelName, AttributeID, AttributeValue);
        ...
        function SetAttributeViBoolean(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_SetAttributeViBoolean', session, ChannelName, AttributeID, AttributeValue);
        ...
        function SetAttributeViSession(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_SetAttributeViSession', session, ChannelName, AttributeID, session);
