classdef InherentIVIAttributes < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = InherentIVIAttributes()
            ...
            obj.UserOptions = instrument.ivic.IviPwrMeter.InherentIVIAttributes.UserOptions();
            obj.DriverIdentification = instrument.ivic.IviPwrMeter.InherentIVIAttributes.DriverIdentification();
            obj.DriverCapabilities = instrument.ivic.IviPwrMeter.InherentIVIAttributes.DriverCapabilities();
            obj.InstrumentIdentification = instrument.ivic.IviPwrMeter.InherentIVIAttributes.InstrumentIdentification();
            obj.AdvancedSessionInformation = instrument.ivic.IviPwrMeter.InherentIVIAttributes.AdvancedSessionInformation();
        end
