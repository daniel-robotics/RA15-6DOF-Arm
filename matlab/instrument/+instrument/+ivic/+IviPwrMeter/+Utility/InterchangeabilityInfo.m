    ...
    methods
        function InterchangeWarning = GetNextInterchangeWarning(obj,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_GetNextInterchangeWarning', session, BufferSize, InterchangeWarning);
        ...
        function ClearInterchangeWarnings(obj)
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_ClearInterchangeWarnings', session);
        ...
        function ResetInterchangeCheck(obj)
            ...
            %guarantee that the IviPwrMeter_GetNextInterchangeWarning
            ...
            try
                ...
                status = calllib( libname,'IviPwrMeter_ResetInterchangeCheck', session);
