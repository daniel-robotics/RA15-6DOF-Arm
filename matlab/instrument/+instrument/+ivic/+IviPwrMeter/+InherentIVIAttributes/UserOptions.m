classdef UserOptions < instrument.ivic.IviGroupBase
    ...
    properties
        ...
        %the IviPwrMeter_InitWithOptions function to override this
        %value.
        Range_Check
        ...
        %IviPwrMeter_InitWithOptions function to override this value.
        ...
        %Use the IviPwrMeter_InitWithOptions function to override
        %this value.
        Simulate
        ...
        %IviPwrMeter_GetNextCoercionRecord function to extract and
        ...
        %call IviPwrMeter_GetNextInterchangeWarning function to
        %extract interchange warnings.  Call the
        %IviPwrMeter_ClearInterchangeWarnings function to clear the
    ...
    methods
        ...
        function set.Range_Check(obj,newValue)
            ...
            [libName, session] = obj.getLibraryAndSession();
            attributAccessors.setLibraryAndSession(libName, session);
            import instrument.ivic.IviPwrMeter.InherentIVIAttributes.UserOptions.*;
