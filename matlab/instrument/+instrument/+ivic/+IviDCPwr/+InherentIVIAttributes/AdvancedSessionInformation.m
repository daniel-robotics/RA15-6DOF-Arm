classdef AdvancedSessionInformation < instrument.ivic.IviGroupBase
    ...
    properties (SetAccess = private)
        ...
        %IviDCPwr_InitWithOptions function.  If you open an
        ...
        %may pass a logical name to the IviDCPwr_init or
        %IviDCPwr_InitWithOptions functions.  The IVI Configuration
