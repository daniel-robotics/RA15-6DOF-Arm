classdef InherentIVIAttributes < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = InherentIVIAttributes()
            ...
            obj.UserOptions = instrument.ivic.IviDCPwr.InherentIVIAttributes.UserOptions();
            obj.ClassDriverIdentification = instrument.ivic.IviDCPwr.InherentIVIAttributes.ClassDriverIdentification();
            obj.SpecificDriverIdentification = instrument.ivic.IviDCPwr.InherentIVIAttributes.SpecificDriverIdentification();
            obj.SpecificDriverCapabilities = instrument.ivic.IviDCPwr.InherentIVIAttributes.SpecificDriverCapabilities();
            obj.InstrumentIdentification = instrument.ivic.IviDCPwr.InherentIVIAttributes.InstrumentIdentification();
            obj.AdvancedSessionInformation = instrument.ivic.IviDCPwr.InherentIVIAttributes.AdvancedSessionInformation();
        end
