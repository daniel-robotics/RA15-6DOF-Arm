classdef Utility < instrument.ivic.IviGroupBase
    ...
    %IVI error information and lock the session.
    ...
    methods (Hidden=true)
        function obj = Utility()
            ...
            obj.ErrorInfo = instrument.ivic.IviDCPwr.Utility.ErrorInfo();
            obj.InterchangeabilityInfo = instrument.ivic.IviDCPwr.Utility.InterchangeabilityInfo();
            obj.CoercionInfo = instrument.ivic.IviDCPwr.Utility.CoercionInfo();
            obj.Locking = instrument.ivic.IviDCPwr.Utility.Locking();
        end
    ...
    methods
        function reset(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_reset', session);
        ...
        function ResetWithDefaults(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_ResetWithDefaults', session);
        ...
        function [SelfTestResult,SelfTestMessage] = self_test(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_self_test', session, SelfTestResult, SelfTestMessage);
        ...
        function Disable(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_Disable', session);
        ...
        function InvalidateAllAttributes(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_InvalidateAllAttributes', session);
        ...
        function [InstrumentDriverRevision,FirmwareRevision] = revision_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_revision_query', session, InstrumentDriverRevision, FirmwareRevision);
        ...
        function [ErrorCode,ErrorMessage] = error_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_error_query', session, ErrorCode, ErrorMessage);
        ...
        function ErrorMessage = error_message(obj,ErrorCode)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_error_message', session, ErrorCode, ErrorMessage);
        ...
        function ChannelString = GetChannelName(obj,Index,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_GetChannelName', session, Index, BufferSize, ChannelString);
        ...
        function SpecificDriverCHandle = GetSpecificDriverCHandle(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_GetSpecificDriverCHandle', session, SpecificDriverCHandle);
