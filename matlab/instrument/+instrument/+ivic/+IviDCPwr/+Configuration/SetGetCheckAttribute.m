classdef SetGetCheckAttribute < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = SetGetCheckAttribute()
            ...
            obj.SetAttribute = instrument.ivic.IviDCPwr.Configuration.SetGetCheckAttribute.SetAttribute();
            obj.GetAttribute = instrument.ivic.IviDCPwr.Configuration.SetGetCheckAttribute.GetAttribute();
            obj.CheckAttribute = instrument.ivic.IviDCPwr.Configuration.SetGetCheckAttribute.CheckAttribute();
        end
