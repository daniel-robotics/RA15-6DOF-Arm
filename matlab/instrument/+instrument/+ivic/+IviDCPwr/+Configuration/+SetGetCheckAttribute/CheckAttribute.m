    ...
    methods
        function CheckAttributeViInt32(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_CheckAttributeViInt32', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViReal64(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_CheckAttributeViReal64', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViString(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_CheckAttributeViString', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViBoolean(obj,ChannelName,AttributeID,AttributeValue)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_CheckAttributeViBoolean', session, ChannelName, AttributeID, AttributeValue);
        ...
        function CheckAttributeViSession(obj,ChannelName,AttributeID)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_CheckAttributeViSession', session, ChannelName, AttributeID, session);
