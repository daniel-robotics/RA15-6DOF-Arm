classdef ErrorInfo < instrument.ivic.IviGroupBase
    ...
    methods
        function [Code,Description] = GetError(obj,BufferSize)
            ...
            %since the user last called IviDCPwr_GetError or
            %IviDCPwr_ClearError.
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_GetError', session, Code, BufferSize, Description);
        ...
        function ClearError(obj)
            ...
            %valid IVI session for the instrumentHhandle parameter, this
            ...
            %have a session handle to pass to the IviDCPwr_GetError
            %function, which occurs when a call to IviDCPwr_init or
            %IviDCPwr_InitWithOptions fails.
            
            narginchk(1,1)
            try
                [libname, session ] = obj.getLibraryAndSession();
                
                status = calllib( libname,'IviDCPwr_ClearError', session);
