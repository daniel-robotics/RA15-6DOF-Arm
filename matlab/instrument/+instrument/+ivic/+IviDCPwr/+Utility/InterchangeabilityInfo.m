classdef InterchangeabilityInfo < instrument.ivic.IviGroupBase
    ...
    methods
        function InterchangeWarning = GetNextInterchangeWarning(obj,BufferSize)
            ...
            %different behavior.  If the IVIDCPWR_ATTR_SPY attribute is
            %set to False, you use this function to retrieve
            %interchangeability warnings.  If the IVIDCPWR_ATTR_SPY
            ...
            %IVIDCPWR_ATTR_INTERCHANGE_CHECK attribute is set to True
            %and you call one of the following functions:
            %IviDCPwr_Initiate () IviDCPwr_Measure ()  If the next
            ...
            %class driver defines as read-only.
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_GetNextInterchangeWarning', session, BufferSize, InterchangeWarning);
        ...
        function ClearInterchangeWarnings(obj)
            ...
            try
                ...
                status = calllib( libname,'IviDCPwr_ClearInterchangeWarnings', session);
        ...
        function ResetInterchangeCheck(obj)
            ...
            %guarantee that the IviDCPwr_GetNextInterchangeWarning
            ...
            %calling the IviDCPwr_GetNextInterchangeWarning function
            %until no more interchangeability warnings are returned.  If
            %you are not interested in the content of those warnings,
            %you can call the IviDCPwr_ClearInterchangeWarnings function.
            
            narginchk(1,1)
            try
                [libname, session ] = obj.getLibraryAndSession();
                
                status = calllib( libname,'IviDCPwr_ResetInterchangeCheck', session);
