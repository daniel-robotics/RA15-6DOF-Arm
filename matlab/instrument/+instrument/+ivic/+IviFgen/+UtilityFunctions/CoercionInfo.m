    ...
    methods
        function CoercionRecord = GetNextCoercionRecord(obj,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_GetNextCoercionRecord', session, BufferSize, CoercionRecord);
