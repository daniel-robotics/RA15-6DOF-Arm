classdef InherentIVIAttributes < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = InherentIVIAttributes()
            ...
            obj.UserOptions = instrument.ivic.IviFgen.InherentIVIAttributes.UserOptions();
            obj.ClassDriverIdentification = instrument.ivic.IviFgen.InherentIVIAttributes.ClassDriverIdentification();
            obj.SpecificDriverIdentification = instrument.ivic.IviFgen.InherentIVIAttributes.SpecificDriverIdentification();
            obj.SpecificDriverCapabilities = instrument.ivic.IviFgen.InherentIVIAttributes.SpecificDriverCapabilities();
            obj.InstrumentIdentification = instrument.ivic.IviFgen.InherentIVIAttributes.InstrumentIdentification();
            obj.AdvancedSessionInformation = instrument.ivic.IviFgen.InherentIVIAttributes.AdvancedSessionInformation();
        end
