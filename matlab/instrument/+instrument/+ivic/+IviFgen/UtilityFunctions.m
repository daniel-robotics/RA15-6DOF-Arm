classdef UtilityFunctions < instrument.ivic.IviGroupBase
    ...
    methods (Hidden=true)
        function obj = UtilityFunctions()
            ...
            obj.ErrorInfo = instrument.ivic.IviFgen.UtilityFunctions.ErrorInfo();
            obj.InterchangeabilityInfo = instrument.ivic.IviFgen.UtilityFunctions.InterchangeabilityInfo();
            obj.CoercionInfo = instrument.ivic.IviFgen.UtilityFunctions.CoercionInfo();
            obj.Locking = instrument.ivic.IviFgen.UtilityFunctions.Locking();
        end
    ...
    methods
        function reset(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_reset', session);
        ...
        function ResetWithDefaults(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_ResetWithDefaults', session);
        ...
        function [SelfTestResult,SelfTestMessage] = self_test(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_self_test', session, SelfTestResult, SelfTestMessage);
        ...
        function Disable(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_Disable', session);
        ...
        function InvalidateAllAttributes(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_InvalidateAllAttributes', session);
        ...
        function [InstrumentDriverRevision,FirmwareRevision] = revision_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_revision_query', session, InstrumentDriverRevision, FirmwareRevision);
        ...
        function [ErrorCode,ErrorMessage] = error_query(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_error_query', session, ErrorCode, ErrorMessage);
        ...
        function ErrorMessage = error_message(obj,ErrorCode)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_error_message', session, ErrorCode, ErrorMessage);
        ...
        function ChannelString = GetChannelName(obj,Index,BufferSize)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_GetChannelName', session, Index, BufferSize, ChannelString);
        ...
        function SpecificDriverCHandle = GetSpecificDriverCHandle(obj)
            ...
            try
                ...
                status = calllib( libname,'IviFgen_GetSpecificDriverCHandle', session, SpecificDriverCHandle);
