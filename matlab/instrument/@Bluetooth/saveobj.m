...
% SAVEOBJ Save filter for BlueTooth objects.
% 
%   B = SAVEOBJ(OBJ) is called by SAVE when a BlueTooth object is
...
for i = 1:length(parseProps)
    ...
    switch className
    case {'Bluetooth', 'serial', 'gpib', 'visa', 'udp', 'tcpip', 'icdevice', 'icgroup'}
