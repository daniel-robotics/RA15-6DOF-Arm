...
%SIZE Size of BlueTooth object array.  
%
%   D = SIZE(OBJ), for M-by-N BlueTooth object array, OBJ, returns  
%   the two-element row vector D = [M, N] containing the number of 
%   rows and columns in the BlueTooth object array, OBJ.  
%
