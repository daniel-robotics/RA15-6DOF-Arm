/*
 *  kernel_cfg.c
 *  Sun Jan 06 11:43:17 2019
 *  SG Version 2.00
 *  sg.exe MotorRegulatorTest.oil -os=ECC2 -I../../ecrobot/../toppers_osek/sg/impl_oil -template=../../ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType BluetoothTask = 1;
const TaskType LCDTask = 2;
const TaskType MainTask = 3;

extern void TASKNAME( MotorRegulatorTask )( void );
extern void TASKNAME( BluetoothTask )( void );
...
static __STK_UNIT _stack_BluetoothTask[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( MotorRegulatorTask ), TASKNAME( BluetoothTask ), TASKNAME( LCDTask ), TASKNAME( MainTask ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_MotorRegulatorTask, (__STK_UNIT)_stack_BluetoothTask, (__STK_UNIT)_stack_LCDTask, (__STK_UNIT)_stack_MainTask, };
...
const AlarmType BluetoothAlarm = 1;
const AlarmType LCDAlarm = 2;
...
static void _activate_alarm_BluetoothAlarm( void );
static void _activate_alarm_BluetoothAlarm( void )
{ (void)ActivateTask( BluetoothTask ); }
...
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_MotorRegulatorAlarm, _activate_alarm_BluetoothAlarm, _activate_alarm_LCDAlarm, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 4, 50, 100, };
